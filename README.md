...
<p><a href="https://github.com/skmahaboobjani/movie_own">Movie App</a></p><br/>
 <p>● Developed a user-friendly interface for a movie app that allows users to easily search for and
   discover new films.</p><br/>
<p>● It is a project of OMDB API for RESTful web service to obtain movie information, all content and
  images on the site</p> .
